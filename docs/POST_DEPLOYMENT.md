...
1. **Open the web UI:**
   ```bash
   open /Users/souvikghosh/.gemini/antigravity/scratch/aws-devops-agent-poc/frontend/index.html
   ```
...
### Web UI URL:
```
file:///Users/souvikghosh/.gemini/antigravity/scratch/aws-devops-agent-poc/frontend/index.html
```
